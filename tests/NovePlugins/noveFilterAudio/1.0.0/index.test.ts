...
describe('Optimistic/Pessimistic Behavior', () => {
  test('Return "no target language found" if pessimistic and stream language is undefined', async () => {
    const args = new PluginInputArgsBuilder()
      .withInput('languages', 'eng')
      .withInput('optimistic', 'false')
      .addAudioStream({ tags: { language: 'und' } })
      .build();
  ...
  test('Return "no target language found" if pessimistic and stream language does not exist in tags', async () => {
    const args = new PluginInputArgsBuilder()
      .withInput('languages', 'eng')
      .withInput('optimistic', 'false')
      .addAudioStream({ tags: { } })
  ...
  test('Return "success" if optimistic and stream language is undefined', async () => {
    const args = new PluginInputArgsBuilder()
      .withInput('languages', 'eng')
  ...
  test('Return "success" if optimistic and stream language does not exist in tags', async () => {
    const args = new PluginInputArgsBuilder()
      .withInput('languages', 'eng')
      .withInput('optimistic', 'true')
      .addAudioStream({ tags: { } })
